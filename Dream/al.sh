...
run_id=0
total_runs=$(( ${#GEN_LENGTHS[@]} * ${#BLOCK_LENGTHS[@]} * ${#TOPKS[@]} * ${#LAYERS_FROM_END[@]} * ${#ALGS[@]} * 50 ))
      ...
      for layer in "${LAYERS_FROM_END[@]}"; do
        for alg in "${ALGS[@]}"; do
          for idx in "${!PROMPTS[@]}"; do
            ...
            run_name="len${gen_length}_blk${block_length}_topk${topk}_layer${layer}_alg${alg}_prompt${prompt_id}"
